...
void updateConfigFromDynamicReconfigure(const dvo_tracking::CameraDenseTrackerConfig& config, dvo::DenseTracker::Config& tracker_cfg)
{
  dvo::core::ScaleEstimators::enum_t scale_estimator;

  switch(config.scale_estimator)
  {
    case dvo_tracking::CameraDenseTracker_NormalDistributionScaleEstimator:
      scale_estimator = dvo::core::ScaleEstimators::NormalDistribution;
      break;
    case dvo_tracking::CameraDenseTracker_TDistributionScaleEstimator:
      scale_estimator = dvo::core::ScaleEstimators::TDistribution;
      break;
    case dvo_tracking::CameraDenseTracker_MADScaleEstimator:
  ...
  {
    case dvo_tracking::CameraDenseTracker_TukeyInfluenceFunction:
      influence_function = dvo::core::InfluenceFunctions::Tukey;
      break;
    case dvo_tracking::CameraDenseTracker_TDistributionInfluenceFunction:
      influence_function = dvo::core::InfluenceFunctions::TDistribution;
      break;
    case dvo_tracking::CameraDenseTracker_HuberInfluenceFunction:
